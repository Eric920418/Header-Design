...
useSeoMeta({
  ...
  description: '下載 iPremium、Joyful、Premium、Harmony、Loft Chic 與 Elegant 六大 SAKURA 整體廚房系列產品型錄。',
  ogTitle: '品牌系列型錄｜SAKURA 整體廚房',
  ogDescription: '瀏覽並下載六大 SAKURA 整體廚房系列產品型錄。',
...
<template>
  <main class="catalogue-page">
    <section class="catalogue-hero" aria-labelledby="catalogue-page-title">
    ...
    <section class="catalogue-projects" aria-labelledby="catalogue-list-title">
      <div class="catalogue-projects__rail internal-rail-safe">
        <h2 id="catalogue-list-title" class="sr-only">六大品牌系列產品型錄</h2>
            ...
            <article>
              ...
              >
                <span class="catalogue-card__transition">
                  ...
                  <span class="catalogue-card__arrow" aria-hidden="true"><ArrowUpRight /></span>
                </span>
...
.catalogue-card__arrow {
  ...
  transition: color .5s ease, opacity .5s ease, visibility .5s ease, transform .5s ease;
}
...
.catalogue-card__text > span { display: block; color: #59585d; font-size: 16px; line-height: 24px; }
...
.catalogue-card__link:hover .catalogue-card__arrow,
.catalogue-card__link:focus-visible .catalogue-card__arrow { opacity: 1; visibility: visible; transform: translateY(0); }
...
@media (max-width: 767px) {
  ...
  .catalogue-projects { padding: 60px 15px; }
  .catalogue-projects__rail.internal-rail-safe { padding-inline: 0; }
  .catalogue-grid { grid-template-columns: 1fr; gap: 42px; }
  .catalogue-card__arrow { right: 18px; bottom: 18px; width: 54px; height: 54px; opacity: 1; visibility: visible; transform: none; }
  .catalogue-card__text strong { min-height: 0; font-size: 26px; line-height: 30px; }
}
