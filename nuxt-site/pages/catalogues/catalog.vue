            ...
            <article>
              ...
              >
                <span class="product-catalogue-card__visual">
                  ...
                  <span class="product-catalogue-card__arrow" aria-hidden="true"><ArrowUpRight /></span>
                </span>
...
.product-catalogue-projects { padding: 92px 30px 128px; background: #f6f6f6; }
.product-catalogue-projects .internal-rail-safe { padding-inline: 43px; }
.product-catalogue-grid { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 58px 30px; margin: 0; padding: 0; list-style: none; }
...
.product-catalogue-card__shade { position: absolute; z-index: 1; inset: 0; background: rgba(0, 0, 0, .035); transition: background-color .45s ease; }
...
.product-catalogue-card__link:hover .product-catalogue-card__arrow,
.product-catalogue-card__link:focus-visible .product-catalogue-card__arrow { opacity: 1; visibility: visible; transform: translateY(0); }
...
.product-care-question__answer { padding: 0 40px 27px 48px; color: #59585d; font-size: 13px; line-height: 22px; }
...
@media (max-width: 767px) {
  ...
  .product-catalogue-card__arrow { right: 18px; bottom: 18px; width: 54px; height: 54px; opacity: 1; visibility: visible; transform: none; }
  ...
  .product-care__header h2 { margin-top: 20px; font-size: 46px; line-height: 50px; }
  ...
  .product-care-question > button > strong { font-size: 19px; line-height: 25px; }
  ...
  .product-care__feature h3 { margin-top: 26px; font-size: 27px; line-height: 33px; }
}

@media (prefers-reduced-motion: reduce) {
  .product-catalogue-card__image :deep(img),
  .product-catalogue-card__shade,
  .product-catalogue-card__arrow,
