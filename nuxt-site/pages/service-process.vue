...
.antra-breadcrumb__trail a { color: #fff; transition: color .3s ease; }
.antra-breadcrumb__trail a:hover { color: #caa05c; }
...
@media (max-width: 767px) {
  .antra-breadcrumb { min-height: 204px; }
