...
.pavilion-image-row { display: flex; gap: 30px; padding: 0; margin-top: 30px; }
...
.pavilion-notes span { color: #caa05c; font-family: var(--font-cjk-sans); font-size: 15px; line-height: 24px; }
.pavilion-notes p { margin: 0; color: #1c1c1d; font-family: var(--font-cjk-sans); font-size: 15px; font-weight: 500; line-height: 24px; }
...
@media (max-width: 767px) {
  ...
  .pavilion-gallery { padding-top: 60px; }
