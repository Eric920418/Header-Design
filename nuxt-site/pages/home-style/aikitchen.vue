...
.ai-intro { padding: 100px 0; background: #fafafa; }
...
.ai-suite-controls button:disabled { border-color: #e3e3e8; color: #c6c6ca; background: #fafafa; cursor: not-allowed; transform: none; }
