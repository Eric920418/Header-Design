    ...
    <section data-hero-photo="songzhu" class="product-detail-hero hero-includes-header" aria-label="產品導覽">
      ...
      <div v-reveal="{ anim: 'opalMoveUp' }" class="product-detail-hero__inner">
        <nav aria-label="麵包屑" class="product-detail-hero__trail">
          <InternalSmartBreadcrumb :fallback='[{ label: "首頁", to: "/" }, { label: "SAKURA 廚電", to: "/products/sakura" }, { label: "除油煙機系列", to: "/products/sakura/range-hood" }, { label: "近吸系列", to: "/products/sakura/range-hood/near-suction" }, { label: product.title }]' v-slot="{ items, follow }">
