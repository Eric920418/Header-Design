...
- **Browser checks**：1512、1024、390 三種寬度均無水平溢出、素材 natural size 正確、無 console error。第 01 卡 SVago logo 在 1512px 為 `125.32×35`、390px 為 `107.41×30`；其新主圖 natural size `1300×945`，在 1512px 為 `430×310`、390px 為 `340×250`。第 02 卡 TEKA SVG 在 1512px 為 `119×35`、390px 為 `102×30`；其主圖 natural size `977×945`，在 1512px 為 `430×310`、390px 為 `340×250`。第 03 卡 SAKURA logo 在 1512px 為 `210×34.05`、390px 為 `170×27.56`；抽油煙機主圖在 1512px 為 `430×310`、390px 為 `340×250`。桌機／手機均確認只渲染這三張品牌卡。三張主圖均以 `object-cover` 正確填滿卡片。
