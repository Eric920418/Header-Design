...
- **加盟優勢卡片對齊（2026-09-01）**：同組兩張優勢卡改為等高，文字長短不同時仍將下方分隔線與圖示列固定對齊；桌機圖示列改為四欄、圖示縮至 34px、欄距縮至 4px，手機維持兩欄以避免中文標籤過度換行。
...
- **加盟插頁英文主標（2026-09-01）**：加盟頁中段、對應建商專區 SAKURA KITCHEN 的深色轉換插頁，主標由 Newsletter 模板假文案改為 `Franchise With SAKURA`；既有背景、說明與表單 CTA 維持不變。
