...
- **重點年表 FAQ 樣式（2026-09-02）**：1978、1992、2016、2020 四個重點年份沿用站內 FAQ 的 18px Noto Serif TC 題目列、灰色編號、純文字加減號、分隔線與展開間距；左側年份圖片及原有正式文案維持不變。
...
- **加盟行銷英文標題（2026-09-01）**：`強大廣告行銷` 改為精簡英文 `Powerful Marketing`，案例輪播與正式中文案例標題維持不變。
