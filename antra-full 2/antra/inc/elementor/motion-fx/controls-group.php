...
class Antra_Elementor_Control_MotionFX extends Group_Control_Base {
	...
	protected function init_fields() {
		$fields = [
			'motion_fx_scrolling' => [
				'label' => esc_html__( 'Scrolling Effects', 'antra' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Off', 'antra' ),
				'label_on' => esc_html__( 'On', 'antra' ),
				'render_type' => 'ui',
		...
		$fields['transform_origin_x'] = [
			'label' => esc_html__( 'X Anchor Point', 'antra' ),
		...
		$fields['transform_origin_y'] = [
			'label' => esc_html__( 'Y Anchor Point', 'antra' ),
			'type' => Controls_Manager::CHOOSE,
			'default' => 'center',
			'options' => [
				'top' => [
		...
		foreach ( $active_devices as $device_key ) {
			$device_label = 'desktop' === $device_key ? esc_html__( 'Desktop', 'antra' ) : $active_breakpoint_instances[ $device_key ]->get_label();

			$devices_options[ $device_key ] = $device_label;
		}

		$fields['devices'] = [
			'label' => esc_html__( 'Apply Effects On', 'antra' ),
		...
		$fields['range'] = [
			'label' => esc_html__( 'Effects Relative To', 'antra' ),
			'type' => Controls_Manager::SELECT,
			'options' => [
				'' => esc_html__( 'Default', 'antra' ),
				'viewport' => esc_html__( 'Viewport', 'antra' ),
				'page' => esc_html__( 'Entire Page', 'antra' ),
			],
			'condition' => [
				'motion_fx_scrolling' => 'yes',
			],
		...
		$fields['motion_fx_mouse'] = [
			'label' => esc_html__( 'Mouse Effects', 'antra' ),
			'type' => Controls_Manager::SWITCHER,
			'label_off' => esc_html__( 'Off', 'antra' ),
			'label_on' => esc_html__( 'On', 'antra' ),
			'separator' => 'before',
	...
	private function get_scrolling_effects() {
		return [
			'translateY' => [
				'label' => esc_html__( 'Vertical Scroll', 'antra' ),
				'fields' => [
					'direction' => [
						...
						'options' => [
							'' => esc_html__( 'Up', 'antra' ),
							'negative' => esc_html__( 'Down', 'antra' ),
						],
					],
					'speed' => [
					...
					'affectedRange' => [
						'label' => esc_html__( 'Viewport', 'antra' ),
						'type' => Controls_Manager::SLIDER,
						'default' => [
							'sizes' => [
								'start' => 0,
			...
			'translateX' => [
				'label' => esc_html__( 'Horizontal Scroll', 'antra' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'antra' ),
						'type' => Controls_Manager::SELECT,
						'options' => [
							'' => esc_html__( 'To Left', 'antra' ),
							'negative' => esc_html__( 'To Right', 'antra' ),
						],
					],
					'speed' => [
						'label' => esc_html__( 'Speed', 'antra' ),
			...
			'opacity' => [
				'label' => esc_html__( 'Transparency', 'antra' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'antra' ),
						'type' => Controls_Manager::SELECT,
	...
	private function get_mouse_effects() {
		return [
			'mouseTrack' => [
				'label' => esc_html__( 'Mouse Track', 'antra' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'antra' ),
						'type' => Controls_Manager::SELECT,
						'default' => '',
						'options' => [
							'' => esc_html__( 'Opposite', 'antra' ),
							'negative' => esc_html__( 'Direct', 'antra' ),
						],
					],
					'speed' => [
						'label' => esc_html__( 'Speed', 'antra' ),
			...
			'tilt' => [
				'label' => esc_html__( '3D Tilt', 'antra' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'antra' ),
						'type' => Controls_Manager::SELECT,
						'default' => '',
						'options' => [
							'' => esc_html__( 'Direct', 'antra' ),
							'negative' => esc_html__( 'Opposite', 'antra' ),
						],
					],
					'speed' => [
						'label' => esc_html__( 'Speed', 'antra' ),
