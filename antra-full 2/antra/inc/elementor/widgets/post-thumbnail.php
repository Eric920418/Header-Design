...
class Antra_Elementor_Post_Thumbnail extends Elementor\Widget_Base {

    public function get_name() {
        return 'antra-post-thumbnails';
    }

    public function get_title() {
        return esc_html__('Antra Post Thumbnail', 'antra');
    }
...
$widgets_manager->register(new Antra_Elementor_Post_Thumbnail());