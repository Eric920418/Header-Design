 ...
 * @since 1.0.0
 */
class Antra_Group_Control_Typography extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['font_family'] = [
			'label' => esc_html_x( 'Family', 'Typography Control', 'antra' ),
		...
		$fields['font_size'] = [
			'label' => esc_html_x( 'Size', 'Typography Control', 'antra' ),
		...
		$fields['line'] = [
			'label' => esc_html_x( 'Line Text', 'Typography Control', 'antra' ),
		...
		$fields['font_weight'] = [
			'label' => esc_html_x( 'Weight', 'Typography Control', 'antra' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'100' => '100 ' . esc_html_x( '(Thin)', 'Typography Control', 'antra' ),
				'200' => '200 ' . esc_html_x( '(Extra Light)', 'Typography Control', 'antra' ),
				'300' => '300 ' . esc_html_x( '(Light)', 'Typography Control', 'antra' ),
				'400' => '400 ' . esc_html_x( '(Normal)', 'Typography Control', 'antra' ),
				'500' => '500 ' . esc_html_x( '(Medium)', 'Typography Control', 'antra' ),
				'600' => '600 ' . esc_html_x( '(Semi Bold)', 'Typography Control', 'antra' ),
				'700' => '700 ' . esc_html_x( '(Bold)', 'Typography Control', 'antra' ),
				'800' => '800 ' . esc_html_x( '(Extra Bold)', 'Typography Control', 'antra' ),
				'900' => '900 ' . esc_html_x( '(Black)', 'Typography Control', 'antra' ),
				'' => esc_html__( 'Default', 'antra' ),
				'normal' => esc_html__( 'Normal', 'antra' ),
				'bold' => esc_html__( 'Bold', 'antra' ),
			],
		];

		$fields['text_transform'] = [
			'label' => esc_html_x( 'Transform', 'Typography Control', 'antra' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => esc_html__( 'Default', 'antra' ),
				'uppercase' => esc_html_x( 'Uppercase', 'Typography Control', 'antra' ),
				'lowercase' => esc_html_x( 'Lowercase', 'Typography Control', 'antra' ),
				'capitalize' => esc_html_x( 'Capitalize', 'Typography Control', 'antra' ),
				'none' => esc_html__( 'Normal', 'antra' ),
			],
		];

		$fields['font_style'] = [
			'label' => esc_html_x( 'Style', 'Typography Control', 'antra' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => esc_html__( 'Default', 'antra' ),
				'normal' => esc_html__( 'Normal', 'antra' ),
				'italic' => esc_html_x( 'Italic', 'Typography Control', 'antra' ),
				'oblique' => esc_html_x( 'Oblique', 'Typography Control', 'antra' ),
			],
		];

		$fields['text_decoration'] = [
			'label' => esc_html_x( 'Decoration', 'Typography Control', 'antra' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => esc_html__( 'Default', 'antra' ),
				'underline' => esc_html_x( 'Underline', 'Typography Control', 'antra' ),
				'overline' => esc_html_x( 'Overline', 'Typography Control', 'antra' ),
				'line-through' => esc_html_x( 'Line Through', 'Typography Control', 'antra' ),
				'none' => esc_html__( 'None', 'antra' ),
			],
		];

		$fields['line_height'] = [
			'label' => esc_html__( 'Line Height', 'antra' ),
			'type' => Controls_Manager::SLIDER,
			'desktop_default' => [
				'unit' => 'em',
			],
		...
		$fields['letter_spacing'] = [
			'label' => esc_html__( 'Letter Spacing', 'antra' ),
			'type' => Controls_Manager::SLIDER,
			'size_units' => [ 'px', 'em', 'rem', 'custom' ],
			'range' => [
				'px' => [
		...
		$fields['word_spacing'] = [
			'label' => esc_html__( 'Word Spacing', 'antra' ),
			'type' => Controls_Manager::SLIDER,
			'size_units' => [ 'px', 'em', 'rem', 'custom' ],
			'range' => [
				'px' => [
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => esc_html__( 'Typography', 'antra' ),
				'settings' => [
					'render_type' => 'ui',
