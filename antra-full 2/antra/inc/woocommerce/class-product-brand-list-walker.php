<?php
/**
 * Antra_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Antra_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Antra_Product_Brand_List_Walker', false)) :

	class Antra_Product_Brand_List_Walker extends Walker {
