<?php
/**
 * Antra WooCommerce Adjacent Products Class
 *
 * @package  aro
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Antra_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Antra WooCommerce Adjacent Products Class
	 */
	class Antra_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'antra_woocommerce_adjacent_query_args', $args ) );
