(function ($) {
    ...
    $(window).on('elementor/frontend/init', () => {
        const addHandler = ($element) => {
            $('li.antra-team-item-titles', $element).on('click', function(e) {
                let id = $(this).data('id');
            ...
            $('li.antra-team-item-titles', $element).hover(
                // Mouse enter
                function() {
                    let id = $(this).data('id');
                    $(this).addClass('show');
                ...
                // Mouse leave
                function() {
                    if ($('li.antra-team-item-titles.show', $element).length === 0) {
                        let id = $(this).data('id');
                        ...
                        if ($('.antra-list-wrapper .antra-item.actived', $element).length === 0) {
                            $('li.antra-team-item-titles:first', $element).addClass('show');
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/antra-teams-accordion.default', addHandler);
    });
